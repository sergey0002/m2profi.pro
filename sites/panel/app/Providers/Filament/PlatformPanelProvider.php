...
class PlatformPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ->id('platform')
            ->path('') // Корень для panel.m2profi.pro.test
            ->domain('panel.m2profi.pro.test')
            ->login(\App\Filament\Platform\Auth\Login::class)
            ->colors([
            ...
            ->pages([
                \App\Filament\Platform\Pages\Dashboard::class,
            ])
