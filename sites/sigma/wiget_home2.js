(function () {
    ...
    var m2WidgetConfig = resolveWidgetConfig();
    var wrgsv = {
        idBox: 'wrgsv',
        url_widget: m2WidgetConfig.sahmatkaUrl + '/display_home_public2.php',
        ...
        loadWidget: function (url, container) {
            ...
            $.ajax({
                ...
                success: (html) => {
                    ...
                    style.href = m2WidgetConfig.assetsUrl + '/wiget_home2.css';
