...
<script src="<?= htmlspecialchars($script_src, ENT_QUOTES, 'UTF-8') ?>?v=1.3.5"></script>
<script>
(function () {
  ...
  var VER = (window.FacadeWidget && FacadeWidget.version) || '1.3.5';
  ...
  document.getElementById('fw_demo_snippet_full').innerHTML = [
    ...
    '    <span class="tok-key">free</span><span class="tok-punct">:</span> <span class="tok-str">\'#789FB1\'</span><span class="tok-punct">,</span> <span class="tok-key">reserved</span><span class="tok-punct">:</span> <span class="tok-str">\'#F2A95F\'</span><span class="tok-punct">,</span> <span class="tok-key">sold</span><span class="tok-punct">:</span> <span class="tok-str">\'#9A9A9A\'</span>',
    '  <span class="tok-punct">},</span>',
