...
<script src="<?= htmlspecialchars($script_src, ENT_QUOTES, 'UTF-8') ?>?v=1.3.1"></script>
<script>
(function () {
  ...
  var VER = (window.FacadeWidget && FacadeWidget.version) || '1.3.1';
  ...
  document.getElementById('fw_demo_snippet_full').innerHTML = [
    ...
    '    <span class="tok-key">free</span><span class="tok-punct">:</span> <span class="tok-str">\'#6B95A5\'</span><span class="tok-punct">,</span> <span class="tok-key">reserved</span><span class="tok-punct">:</span> <span class="tok-str">\'#E5A35D\'</span><span class="tok-punct">,</span> <span class="tok-key">sold</span><span class="tok-punct">:</span> <span class="tok-str">\'#9B938F\'</span>',
    '  <span class="tok-punct">},</span>',
