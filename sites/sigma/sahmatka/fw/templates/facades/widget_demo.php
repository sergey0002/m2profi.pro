...
<script src="<?= htmlspecialchars($script_src, ENT_QUOTES, 'UTF-8') ?>?v=1.3.31"></script>
<script>
(function () {
  ...
  var VER = (window.FacadeWidget && FacadeWidget.version) || '1.3.7';
  ...
  document.getElementById('fw_demo_snippet_full').innerHTML = [
    ...
    '    <span class="tok-key">free</span><span class="tok-punct">:</span> <span class="tok-str">\'#7095A3\'</span><span class="tok-punct">,</span> <span class="tok-key">reserved</span><span class="tok-punct">:</span> <span class="tok-str">\'#DAA152\'</span><span class="tok-punct">,</span> <span class="tok-key">sold</span><span class="tok-punct">:</span> <span class="tok-str">\'#D3D3D3\'</span>',
    '  <span class="tok-punct">},</span>',
