...
<div class="container-fluid" style="padding:20px;">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-xs-12" style="text-align:center; position:relative;">
      <img src="https://xdemo.m2profi.pro/sahmatka//images/parkingcar.png" style="max-height:600px; max-width:100%">
        ...
        <div class="tabs noprint">
          ...
          <div class="tabs__content active" style="padding-left: 0; font-size:16px;">
            <div class="row">
              ...
              <div class="col-md-6">
                <form action="/ajax_form.php" method="post" enctype="multipart/form-data" method="post" class="ajax_form">
