...
.mdl-tabs__item.active {
  ...
  <div class="mdl-inner" id="printableArea">
    <div class="mdl-head">
      ...
      <div class="mdl-head-row no-print">
        <div class="mdl-head-group">
          <a href="#" class="mdl-back" data-fancybox-close>Назад к выбору  </a>
          <div class="mdl-dnd">
      ...
      <div class="mdl-title no-print">Заявка на бронирование парковки</div>
      <div class="mdl-prm"> №<?=$result['num'];?></div>
    </div>
    <div class="mdl-body" data-tabs="mdl">
      <div class="mdl-body-top no-print">
        <div class="mdl-tabs" data-tabs-nav>
          <div class="mdl-tabs__item active" style="display:none;" data-tabs-target="tab-1">Планировка</div>
          <div style="display:none;" class="mdl-tabs__item" data-tabs-target="tab-2">На этаже</div>
          ...
          <div class="mdl-pln">
            <div class="mdl-pln__top"><?=$data['data']['homes_kvartal_title']?>  </div>
				<div class="col-md-6 col-xs-12" style="text-align:center; position:relative;">
				  <img src="https://xdemo.m2profi.pro/sahmatka//images/parkingcar.png" style="max-height: 500px; max-width: 100%; display: inline-block;  ">
      ...
      <div class="mdl-content" data-tabs-content="tab-2">
        <div class="mdl-main">
          ...
          <div class="mdl-pln">
            <div class="mdl-pln__top"><?=$data['data']['homes_kvartal_title']?></div>
            <img class="lazy" data-src="https://m2profi.pro/images/mdl-view.webp" src="https://m2profi.pro/images/mdl-view.webp" data-srcset="https://m2profi.pro/images/mdl-view@2x.webp 2x" alt="" />
            <div class="mdl-pln__bottom"><?=$data['data']['adress']?>    </div>
          </div>
        </div>
      </div>
    ...
    <div class="mdl-foot">
      ...
      <form action="https://xdemo.m2profi.pro/sahmatka/ajax_router.php?ctr=parking_spaces&act=card_ajaxform" method="POST"  data-fp-id="public_pcard" class="formprotect mdl-form no-print  ">
	  <input type="hidden" name="adress_disp" value="<?=$data['adress_disp']?>" />
	  <input type="hidden" name="floor" value="<?=$result['floor'];?>" />
	  ...
	  <input type="hidden" name="area" value="<?=$result['area']?>" />
		...
		<?= FormProtect::hiddenFields('public_pcard') ?>
