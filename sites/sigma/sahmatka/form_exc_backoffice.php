...
include('config.php');
	...
	if( $_SESSION['agency_id'] == "92" || check_access('admin') ) //  
	{
		?>
...
<select id="home" name="home" style="max-width:100%;">
	...
	<option value="1">Каспийская, 5 (<?= unit_phrase('ready_units') ?>)</option>
...
<input name="manager" type="text" style="max-width:100%;" placeholder="Менеджер ОП" required />
  
<select id="peoples" name="peoples" style="max-width:100%; display:none;">
