...
(function (global) {
  ...
  var WIDGET_CSS = [
    ...
    '@media (min-width: 900px) {',
    '  .fw-root.is-view-floor .fw-view--floor { width: 100%; box-sizing: border-box; padding: 0 15px; background: #fff; }',
    '  .fw-root.is-view-floor .fw-plan-layer { width: 100%; max-width: 960px; margin: 0 auto; padding: 32px 0 48px; box-sizing: border-box; }',
    ...
    '  .fw-root.is-view-floor .fw-view--floor { padding: 0 15px; }',
    '  .fw-root.is-view-floor .fw-plan-layer { max-width: 1140px; padding-top: 40px; padding-bottom: 56px; }',
    '}',
    ...
    '@media (min-width: 900px) {',
    '  .fw-root.is-view-card .fw-view--card { width: 100%; box-sizing: border-box; padding: 24px 15px 40px; background: #fff; }',
    '  .fw-root.is-view-card .fw-card { width: 100%; max-width: 960px; margin: 0 auto; min-height: min(88vh, 920px); box-sizing: border-box; }',
    '}',
    '@media (min-width: 1200px) {',
    '  .fw-root.is-view-card .fw-card { max-width: 1140px; }',
    '}',
