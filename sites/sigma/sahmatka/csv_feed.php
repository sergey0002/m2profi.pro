...
$headers = [
    'Уникальный ID дома',
    unit_phrase('csv_unique_id'),
    'Дата создания фида',
    'Адрес дома',
    unit_phrase('csv_num'),
    unit_phrase('csv_status'),
    'Название дома',
    'Секция дома',
    'Цена',
    'Количество комнат',
...
multi_attach_mail('on_potapenko@bk.ru', unit_phrase('feed_subject') . ' '. $date, 'Файл с фидом во вложении', 'test@m2profi.pro',  'em-nsk.ru', $files  );


multi_attach_mail('89236470002@mail.ru', unit_phrase('feed_subject') . ' '. $date, 'Файл с фидом во вложении', 'test@m2profi.pro',  'em-nsk.ru', $files  );




/*
https://xdemo.m2profi.pro/sahmatka/csv_feed.php - Фид CSV все дома в продаже 
