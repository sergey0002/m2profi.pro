...
{	 
	...
	$message .= "Дом <b>".$new_homes[$home_id] ."</b> секция-<b>".$_GET[section_id]."</b> Этаж-<b>". $_GET[floor]."</b> " . unit_num($apartment_num, 'dash') . " ";
	//print $message;	 
         ...
         <div class="container-fluid" style="padding:20px;">
            <div class="row">
			   ...
			   <div class="col-md-12 col-xs-12" style="font-size:16px; text-transform: uppercase;">
				Секция -  <?=$result['section_id'];?> <br/>Этаж -  <?=$result['floor'];?>  <br/> <?= unit_label_cap('nom') ?> -   <?=$result['apartment_num'];?> 
			   </div>
	...
	<div class="row">
			...
			<div class="col-md-6">
				 ...
				 <div style="width:100%; max-width:300px;">
							...
							<br/>
						<input type="checkbox" id="politic" name="politic" value="1" style="display:inline; cursor:pointer; width:auto;">
						<label for="politic" style="display:inline; cursor:pointer; width:auto; font-size:14px; font-weight:normal; color:#333;"> Я    
						<a href="https://em-nsk.ru/sitedoc/agreement.docx" style="color:#333;">согласен</a>  на обработку персональных данных.  
						С <a href="https://em-nsk.ru/sitedoc/politic.docx" style="color:#333;">Политикой обработки персональных данных</a> ознакомлен и согласен.</label>
