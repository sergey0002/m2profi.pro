...
foreach ($arr as $v) {
    ...
    <div class="stat-rooms-item<?= $cll ?>">
        ...
        <ul class="stat-rooms-item-list<?= $cll ?>">
            <li><span>Всего <?= unit_label('pl_gen') ?>:</span> <span><?= $v['c'] ?></span></li>
            ...
            <li><span><?= unit_phrase('not_sold') ?>:</span> <span><?= $not_sold ?></span></li>
        </ul>
    </div>
    <?php
}
...
<section class="section-stat">
    <div class="container">
        <div class="page-header">
            ...
            <div class="page-header__title">СТАТИСТИКА <span><?= unit_label('pl_gen') ?></span></div>
        </div>
        <div class="stat">
