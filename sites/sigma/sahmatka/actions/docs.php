...
<section class="section-stat">
	<div class="container mobc">
		...
		<div class="stat">
			...
			<div class="row acc-head slh_active"  >
				<div class="col-md-12">
			...
			<div class="row acc-body slb_active"  >
			...
			<div class="row"   style="  margin: 15px;    border-bottom: 1px solid #EEE;    margin-bottom: 30px; ">
				<div class="col-md-6" style="padding-left: 0;">
					...
					<div class="stat-docs-item" style="float:left; width:auto; min-width: 250px; "  >
						<div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt="" /></div>
						<a class="stat-docs-item__title iframe_r"  href="https://em-nsk.ru/sahmatka2/reglament.php?q=https://xdemo.m2profi.pro/oferta/stalker.docx?x=<?=rand(0,1000000)?>">
				 ...
				 <div class="col-md-6" style="padding-left: 0;">
					...
					<div class="stat-docs-item"  style=" display:none;  width:auto; min-width: 250px;" >
						<div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt="" /></div>
						<a class="stat-docs-item__title iframe_r"  href="https://em-nsk.ru/sahmatka2/reglament.php?q=https://xdemo.m2profi.pro/oferta/m2.docx?x=<?=rand(0,1000000)?>">
			...
			<div class="row acc-head"   style="    border-bottom: 1px solid #EEE; cursor: not-allowed; display:none;" >
				<div class="col-md-12">
