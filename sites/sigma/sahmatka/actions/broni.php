...
if($_SESSION['sh_login'] && !$_SESSION['adm_caption'] && !check_access('admin') &&  $_SESSION['sh_login']!='uservip' &&  $_SESSION['sh_login']!='partner'  &&  $_SESSION['sh_login']!='admin_demo')
{
	$q.='AND users.login="'.$_SESSION['sh_login'].'"  '; // только его брони
}
//  админ агентства
elseif($_SESSION['sh_login'] && $_SESSION['adm_caption'] && !check_access('admin') &&  $_SESSION['sh_login']!='uservip' &&  $_SESSION['sh_login']!='partner'  &&  $_SESSION['sh_login']!='admin_demo')
{
	$q.='AND agency.agency_id="'.$_SESSION['agency_id'].'"  '; // только брони агентства
	$q.='AND users.login="'.$_SESSION['sh_login'].'"  '; // только его брони
}	
//  админ всея руси
elseif(   check_access('admin')   ||  $_SESSION['sh_login']!='admin_demo')
{
	// все брони
	?>
