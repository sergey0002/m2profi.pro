...
require_once __DIR__ . '/../sahmatka/config.php';
	...
	private function getApartmentById($apartmentId)
	{
		...
		try {
			...
			if ($result) {
				...
				$this->sendResponse(404, ["error" => unit_phrase('api_not_found')]);
			}
		} catch (PDOException $e) {
			$this->sendResponse(500, ["error" => unit_phrase('api_fetch_error') . ": " . $e->getMessage()]);
		}
	}
