	...
	<div class="row">
		<div class="col login-modal-col-main">
			<div class="login-modal-main">
				<a href="https://xn--80aci4cj6cf.xn--p1ai/" class="login-modal__linkback">Вернуться на сайт</a>
			...
			<div class="login-modal-pict">
				<div class="login-modal__caption">
					...
					<div class="login-modal__contact">
						<div class="login-modal__contact-item">Тел./whatsapp: <a href="https://wa.me/79609396880">+7 960
								939-68-80</a></div>
						<div class="login-modal__contact-item">E-Mail: <a
								href="mailto:info@g-lounge.ru">info@g-lounge.ru</a></div>
					</div>
				</div>
			</div>
		</div>
