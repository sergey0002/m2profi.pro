			  ...
			  // ФОрма брони / редактирования
				$.magnificPopup.open({
				 closeMarkup:"<button title='%title%' style='top:-60px;' type='button' class='mfp-close myDisplayOverride'><img src='/sahmatka/images/x.png'></button>",
				  items: {
					  src: 'https://gl.m2profi.pro/sahmatka/iframe_router.php?ctr=landplots&act=order&polygon_id='+$(this).attr('data-id')+'&a=<?=$_SERVER['SCRIPT_NAME']?>'
...
{	
	...
	$.ajax({
		url: 'https://gl.m2profi.pro/sahmatka/ajax_router.php?ctr=landplots&act=jsoondata',
		method: 'get',
		dataType: 'json',
