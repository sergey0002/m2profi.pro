...
<?
	...
	function act__order()
	{
		...
		elseif($_POST)
		{
			...
			$to = '89236470002@mail.ru,op@em-nsk.group,op03@em-nsk.group';
	...
	function act__broniform()
	{
		...
		else
		{
			...
			if( multi_attach_mail( $to , 'Бронь на аренду помещения', $mess, '89236470002@mail.ru' , 'Бронь на аренду - em-nsk.ru'  , $files )  )
			{
				?>
				<section>
					<div class="container " style=" text-align: center; max-width: 475px;">
	...
	function act__fastorder()
	{
		...
		elseif( $_POST )
		{
			...
			if( multi_attach_mail( $to , 'Заявка на аренду помещения', $mess, '89236470002@mail.ru' , 'Заявка аренда - em-nsk.ru'  , $files ) )
			{
				?>
				<section>
					<div class="container " style=" text-align: center; max-width: 475px;">
