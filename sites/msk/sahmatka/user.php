...
if( $_GET['url'] )
{ 
	$_GET['url'] = 'Location: https://msk.m2profi.pro/'.$_GET['url'];
	header($_GET['url']);
	exit();
}
...
{	 
 ...
 {
	?>
	<script>window.location.href = "https://msk.m2profi.pro/sahmatka/ctrind.php?ctr=landplots&act=index"</script>
	<?
 }
 ...
 if($_GET['action']=='objects2') // Агентства (администратор)
{
 ...
 {
	?> <script>window.location.href = "https://gl.m2profi.pro/sahmatka/ctrind.php?ctr=landplots&act=index"</script><?
 }
