...
if( $_GET['url'] )
{ 
	$_GET['url'] = 'Location: https://em.m2profi.pro/'.$_GET['url'];
	header($_GET['url']);
	exit();
}
...
if( !$_GET['action'] )
{ 
	$_GET['url'] = 'Location: https://demorent.m2profi.pro/sahmatka/ctrind.php?ctr=rentobjects&act=index_ag';
	header($_GET['url']);
	
	?>
	
	 <script>
        window.location.href = "https://demorent.m2profi.pro/sahmatka/ctrind.php?ctr=rentobjects&act=index_ag";
    </script>
...
elseif($_SESSION['sh_login'] == 'admin' || $_SESSION['sh_login'] == 'director' || $_SESSION['sh_login'] == 'fd' || $_SESSION['sh_login'] == 'demo_admin')
{
...
if($_SESSION['sh_login'] != 'admin' && $_SESSION['sh_login'] != 'fd' &&  $_SESSION['sh_login'] != 'demo_admin' && $_SESSION['adm_caption'] )
{
 ...
 if($_GET['action']=='objects2') // Агентства (администратор)
{
 ...
 elseif($_SESSION['sh_login'] != 'admin'  && $_SESSION['sh_login'] != 'fd' && $_GET['action']=='objects') // Обьекты (администратор)
 {
		//object_menu();
		if($_GET['home']  && !$_GET['apartments'] )
		{
...
elseif($_SESSION['sh_login'] && !$_SESSION['adm_caption'] && $_SESSION['sh_login']!='admin' && $_SESSION['sh_login']!='demo_admin' && $_SESSION['sh_login'] != 'fd' &&  $_SESSION['sh_login']!='uservip' &&  $_SESSION['sh_login']!='partner' )
{
