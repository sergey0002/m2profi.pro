	...
	function act__edit()
	{
		...
		.input_edit {width:100%; max-width:100%;}
			...
			<hr/>
				...
				<?=$filed->select('ready_quarter','вартал сдачи (Домлик)',array('1'=>'1','2'=>'2','3'=>'3','4'=>'4'),$data['ready_quarter']);?><br/>
				...
				ID ЖК <?=$filed->text('yandex-building-id','yandex-building-id',$data['yandex-building-id']);?><br/>
				
				ID дома <?=$filed->text('yandex-house-id','yandex-house-id',$data['yandex-house-id']);?><br/>
