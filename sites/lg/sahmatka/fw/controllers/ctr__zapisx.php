	...
	function act__sel_date_zapisx()
	{
		...
		{  
			 ...
			 { 
				...
				if($fd == '24.01.2024' && $_POST['home_id'] == "37" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '25.01.2024' && $_POST['home_id'] == "37" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '26.01.2024' && $_POST['home_id'] == "37" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '30.01.2024' && $_POST['home_id'] == "37" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '31.01.2024' && $_POST['home_id'] == "37" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '01.02.2024' && $_POST['home_id'] == "37" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				
				if($fd == '06.02.2024' && $_POST['home_id'] == "37" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = true;}
				if($fd == '07.02.2024' && $_POST['home_id'] == "37" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = true;}
				if($fd == '08.02.2024' && $_POST['home_id'] == "37" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = true;}
				
				
				 
				//707
				if($fd == '13.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '14.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '15.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '16.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '20.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '21.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				if($fd == '22.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = false;}
				
				
				if($fd == '27.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = true;}
				if($fd == '28.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = true;}
				if($fd == '29.02.2024' && $_POST['home_id'] == "36" && $_POST['section_id']!="1" && $_POST['section_id']!="3" ){$iskl = true;}
		...
		else
		{
			...
			if( 0 < $free  )
			{
				...
				{ 	 
					...
					multi_attach_mail('s89236470002@yandex.ru', 'Запись на выдачу ключей - дом:'.$this->homes_arr[$data['home_id']]['title'].' кв.:'.$data['apartment_num'].' дата:'.$_POST['date'].' время:'.$data['time'], $con, 'admin@m2profi.pro', $GLOBALS['config']['domain']);
					
					multi_attach_mail('89236470002@mail.ru', 'Запись на выдачу ключей - дом:'.$this->homes_arr[$data['home_id']]['title'].' кв.:'.$data['apartment_num'].' дата:'.$_POST['date'].' время:'.$data['time'], $con, 'sdsasd@m2profi.pro', $GLOBALS['config']['domain']);
