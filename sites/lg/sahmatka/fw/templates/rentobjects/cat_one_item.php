          ...
          <div class="grey_shadow">
			...
			//	print '</div>'; 
				?>
			 	...
			 	<p>
                  <a href="https://{$GLOBALS['config']['domain']}/sahmatka/iframe_router.php?ctr=rentobjects&act=card&id=<?=$v['rent_objects_id']?>#map" class="rent_a iframerent"><img src="https://em-nsk.ru/m2rent/images/map.svg" alt=""> на карте</a>
                </p>
				<br/>
                <p><?=$v['comment']?></p>
			 
			  <p><a href="https://{$GLOBALS['config']['domain']}/sahmatka/iframe_router.php?ctr=rentobjects&act=card&id=<?=$v['rent_objects_id']?>" class="rent_a iframerent" style="text-decoration: underline;">Подробнее</a></p>
              </div>
