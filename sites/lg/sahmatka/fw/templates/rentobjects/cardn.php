	...
	*/
	...
	<div class="row">
							...
							foreach($files  as $file) 
							{
								...
								{		
									...
									if('jpg'==end(explode(".", $src)))
									{
										...
										?>  
										<div  class="swiper-slide" ><img class="rent_img"  src="https://{$GLOBALS['config']['domain']}/thumbs/?name=/sahmatka/<?=$src;?>&w=800&h=800" style="object-fit: contain;" /> </div>
										<? 
									}
									elseif(1==2)
									{
										?>  <div class="swiper-slide"><img class="rent_img"  src="https://{$GLOBALS['config']['domain']}/thumbs/?name=/sahmatka/<?=$src;?>" style="object-fit: contain;" /></div><? 
									}							
								} 
							}
						  ?>
        ...
        Технические характеристики <a href="javascript:(print());"> <img src="https://nsk.rent/img/print.svg" alt=""></a> </h4>
			...
			<a data-wrapper="#ajax-wrapper" class="ajfb" data-url="https://{$GLOBALS['config']['domain']}/sahmatka/ajax_router.php?ctr=rentobjects&act=cardn_form&id=<?=$data['rent_objects_id']?>"  href="https://{$GLOBALS['config']['domain']}/sahmatka/ajax_router.php?ctr=rentobjects&act=cardn_form&id=<?=$data['rent_objects_id']?>"  >
