  ...
  <div class="mdl-inner" id="printableArea">
    <div class="mdl-head">
      ...
      <div class="mdl-head-row no-print">
        <div class="mdl-head-group">
          <a href="#" class="mdl-back" data-fancybox-close>Назад к выбору квартир</a>
          <div class="mdl-dnd">
      ...
      <div class="mdl-prm"><?=$data['data']['rooms']?>К | <?=$data['data']['area']?>м2</div>
    </div>
    ...
    <div class="mdl-foot">
      <div class="mdl-desc">
        ...
        <p>Секция:  <?=$data['data']['section_caption']?></p>
        <p>Этаж:  <?=$data['data']['floor']?></p>
        <p>Квартира: №<?=$data['data']['apartment_num']?></p>
      </div>
      <div class="mdl-price"><?=$price?> ₽</div>
      <div class="mdl-cnt">
        <p>
          ОТДЕЛ ПРОДАЖ<br>
      ...
      <form action="#" class="mdl-form no-print">
        ...
        <button class="mdl-form__btn h-btn">Забронировать</button>
        <div class="mdl-form__accept">
          Нажимая кнопку «Отправить», вы подтверждаете свое согласие на обработку <a href="#"
            target="_blank">персональных данных</a> и получение рекламных
          рассылок.
        </div>
      </form>
    </div>
