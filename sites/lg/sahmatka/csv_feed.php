...
multi_attach_mail('on_potapenko@bk.ru', 'Фид квартир '. $date, 'Файл с фидом во вложении', 'test@m2profi.pro',  $GLOBALS['config']['domain'], $files  );


multi_attach_mail('89236470002@mail.ru', 'Фид квартир '. $date, 'Файл с фидом во вложении', 'test@m2profi.pro',  $GLOBALS['config']['domain'], $files  );
