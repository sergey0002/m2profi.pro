...
$str_arr3['area']= $str_arr[10]; /// ПЕРЕНЕС 
$str_arr3['display_num']= $str_arr[7]; /// ПЕРЕНЕС 

$str_arr3['rooms']= $str_arr[1];
$str_arr3['area']=str_replace(',','.',$str_arr3['area']);
...
//	/home/m2profi/web/m2profi.pro/public_html/sites/em/sahmatka/pbplans/34
   ...
   $sql = 'INSERT INTO `apartaments` (`home_id`, `section_id`, `apartment_num`, `floor`, `price`, `area`, `rooms`, `kitchen_area`, `text`, `house_adress`, `adress`, `image_pb`,`display_num`)
VALUES (
"'.$str_arr3['home_id'].'",
"'.$str_arr3['section_id'].'", 
