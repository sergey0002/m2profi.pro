...
# ИНФОРМАЦИЯ О ДОМЕ
$data_home = $mysql->get_arr('SELECT * FROM homes WHERE `show`="1" AND home_id = "'.$home_id.'"',1); 
 //print_r($data_home);
...
$jk_img[37][]='https://' . $GLOBALS['config']['domain'] . '/'sahmatka/render/37.jpg';
$jk_img[38][]='https://' . $GLOBALS['config']['domain'] . '/'sahmatka/render/38.jpg';
$jk_img[39][]='https://' . $GLOBALS['config']['domain'] . '/'sahmatka/render/39.jpg';
$jk_img[40][]='https://' . $GLOBALS['config']['domain'] . '/'sahmatka/render/40.jpg';
$jk_img[41][]='https://' . $GLOBALS['config']['domain'] . '/'sahmatka/render/41.jpg';
					...
					if(is_array($data_apartaments))
					{
						...
						foreach($data_apartaments as $flats_k=>$flats_v)
						{
							...
							<flat>  
							  ...
							  <balcony>Нет</balcony>
							  <renovation>чистовая</renovation><? /* да */?>
