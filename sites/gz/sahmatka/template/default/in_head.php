...
<div class="sidenav">
	...
	<div class="sidenav-wrap">
		...
		<a href="http://g-lounge.ru" class="sidenav__backlink">Вернуться на сайт</a>
		
		<div class="sidenav-nav">
			<a href="http://g-lounge.ru" class="sidenav__backlink sidenav__backlink_mob">Вернуться на сайт</a>
			...
			<ul class="sidenav-menu">
				...
				<?
				if( ($_SESSION['sh_login'] == 'admin' || $_SESSION['sh_login'] == 'goodzem')  ) // Администратор !!!!проверять отдел администраторы!
				{
				?>
				...
				<?
				if( $_SESSION['sh_login'] == 'admin' ||   $_SESSION['sh_login'] == 'goodzem' ||  $_SESSION['sh_login'] == 'director' ||  $_SESSION['sh_login'] == 'fd' ) // Администратор !!!!проверять отдел администраторы!
				{
				?>
				...
				<?
				if($_SESSION['sh_login'] == 'admin'  ||   $_SESSION['sh_login'] == 'goodzem' || $_SESSION['sh_login'] == 'fd' ) // Администратор !!!!проверять отдел администраторы!
				{
					?>
				...
				<?
				if( $_SESSION['sh_login'] == 'admin' || $_SESSION['sh_login'] == 'goodzem' || $_SESSION['sh_login'] == 'op15' || $_SESSION['sh_login'] == 'fd')
				{
				?>
				<li class="sidenav-dropmenu" style="display:none;">
					...
					<ul class="sidenav-submenu <? if($statm){?>active<?} ?>" <? if($statm){?>style="display: block;"<?}	?>>
						...
						<?
							if( $_SESSION['sh_login'] == 'admin' || $_SESSION['sh_login'] == 'goodzem' || $_SESSION['sh_login'] == 'op15' )
							{
							?>
