...
<select id="home" name="home" style="max-width:100%;">
	...
	<option value="1">Каспийская, 3 (готовые квартиры с ремонтом)</option>
...
elseif($_POST['home']==1)
{
		$mess.= '<b> Ждем вас за 15 мин до начала экскурсии по адресу: Каспийская 3, 5 подъезд.</b><br/>';
}
elseif($_POST['home']==3)
{
...
{
		$mess.= '<b>Ждем вас за 15 мин до начала экскурсии по адресу: Красный проспект 327/3.</b> (2-й подъезд)<br/>  <br/> <div style="text-align:center; color:red; font-size18px; font-weight:bold;">
			   ОБРАЩАЕМ ВНИМАНИЕ:<br/>
<br/>
...
{
		$mess.= '<b>Ждем вас за 15 мин до начала экскурсии по адресу: Красный проспект 331/2</b><br/>';
}	
