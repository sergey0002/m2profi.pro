...
WHERE (`apartaments`.`status2` = "2" or `apartaments`.`status2` = "" or `apartaments`.`status2` IS NULL) AND rooms>0 AND  homes.show=1 ';
...
<section class="section-stat">
	<div class="container">
		<div class="page-header">
			...
			<div class="page-header__title">СТАТИСТИКА <span>средняя стоимость м<sup>2</sup></span></div>
		</div>
