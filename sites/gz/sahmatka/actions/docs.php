    ...
    padding: 10px;">
					...
					<div class="row" style="width:100%; display:no!ne; margin-top:30px;">
						<div class="col-md-4">
							<div class="stat-docs-item" style="  width:auto; min-width: 250px;">
								<div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt="" /></div> 
								<a class="stat-docs-item__title iframe_r" href="https://gl.m2profi.pro/doc/reglament.php?q=/doc/dogovor.docx">Субагентский <br>договор</a>
							</div>
						</div>
						<div class="col-md-4">
							<div class="stat-docs-item" style="  width:auto; min-width: 250px;">
				    ...
				    <div class="row" style="width:100%; display:n!one;">
						...
						<div class="col-md-4">
							<div class="stat-docs-item">
								<div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt="" /></div> 
								<a href="https://gl.m2profi.pro/doc/reglament.php?q=/doc/uvedomlenie.docx" class="stat-docs-item__title iframe_r">Форма уведомления</a> 
							</div>
						</div>
						<div class="col-md-4">
							<div class="stat-docs-item">
