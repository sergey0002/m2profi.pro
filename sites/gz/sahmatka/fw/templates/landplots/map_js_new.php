...
{ 
	// return false; ///  ВЫРУБАЕМ КАРТУ (КЛИКИ ПО КАРТЕ)
		...
		{ 
			...
			$.magnificPopup.open({
			  items: {
				src: 'https://gz.m2profi.pro/sahmatka/iframe_router.php?ctr=landplots&act=order&polygon_id='+$(this).attr('data-id')+'&map_id='+map_id+'&a=/sites/gl/sahmatka/ctrind.php'
			  },
...
{	
  $('#map__'+map_id+' .scheme text').hide();
	$.ajax({
		url: 'https://gz.m2profi.pro/sahmatka/ajax_router.php?ctr=landplots&act=jsoondata&map_id='+map_id,
		method: 'get',
		dataType: 'json',
