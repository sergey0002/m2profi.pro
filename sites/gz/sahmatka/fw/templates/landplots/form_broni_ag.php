...
<div class="container-fluid">
  ...
  <div style="color:#00CDBC; font-size:16px;  font-weight: 600;  font-family: 'Montserrat', sans-serif; ">Локация/квартал</div>
         <h1 style="line-height:44px; font-size:34px; font-family: 'Montserrat', sans-serif; font-weight: 600;  font-size: 32px;  " > <?=$GLOBALS['gl_raion'][$data['raion']]?>   </h1>   
  </div>
  ...
  <div class="row">
	<div class="col-md-6 col-xs-6" style="text-align:left;  ">	
		<img src="/sahmatka/hrender/1.png" width="100%" style="max-width:100%" />
		<br/><br/>
	...
	{
	?>
	<form action="iframe_router.php?ctr=landplots&act=order&map_id=<?=$_GET['map_id'];?>&polygon_id=<?=$_GET['polygon_id'];?>" method="post" enctype="multipart/form-data" method="post">
		...
		<div class="col-md-12 col-xs-12" style="text-align:left; font-size:24px;">	
			...
			<?
			 // 
				...
				{
					$filed->text('kadastrnum','Кадастровый номер',$data['kadastrnum']);
				}
				else
				{
