...
<section class="section-stat">
    ...
    <div style="background-color: #dc3545; color: #FFF; padding: 12px 15px; margin-bottom: 20px; border-radius: 4px; font-weight: 500; line-height: 1.4; text-align:center;">
        Уважаемые партнеры, при направлении документов по ЭДО, необходимо применять форматы документов, утвержденные ФНС России.<br>
        <strong>УПД по ЭДО возможно направить ТОЛЬКО в формате .xml</strong>
    </div>

    <!-- Заголовок раздела (статичный, без аккордеона) -->
    <div class="row acc-head slh_active" style="border-bottom: 1px solid #EEE; margin-bottom: 20px; cursor: default;">
        <div class="col-md-12">
            <span class="helink helink-a right-line-header" style="line-height: 45px; color: #000; font-size: 18px; font-weight: 600;">
                Жилая недвижимость
            </span>
        </div>
    </div>
    ...
    <!-- Блок документов -->
    <div class="row acc-body slb_active" style="display: block;">
        ...
        <!-- Договоры для ИП и ООО (были скрыты - оставляем скрытыми) -->
        <div class="row" style="margin: 15px; border-bottom: 1px solid #EEE; margin-bottom: 30px; display:none;">
            <div class="col-md-6" style="padding-left: 0;">
                ...
                <div class="stat-docs-item" style="float:left; width:auto; min-width: 250px; ">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=/sahmatka2/dog01072024/dog_stalker_ip01.07.24.docx">
                        Субагентский <br>договор <br> OOO "Сталкер" 
                    </a>
                </div>
                
                <div class="stat-docs-item" style="display:none; width:auto; min-width: 250px;">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=/sahmatka2/dog01072024/dog_m2_ip01.07.24.docx">
            ...
            <div class="col-md-6" style="padding-left: 0;">
                ...
                <div class="stat-docs-item" style="float:left; width:auto; min-width: 250px;">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=/sahmatka2/dog01072024/dog_stalker_ooo01.07.24.docx">
                        Субагентский <br>договор <br> OOO "Сталкер" 
                    </a>
                </div> 
                ...
                <div class="stat-docs-item" style="width:auto; min-width: 250px;">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=/sahmatka2/dog01072024/dog_m2_ooo01.07.24.docx">
                        Субагентский <br>договор <br> ООО "М2" 
                    </a>
                </div> 
            </div>
        ...
        <!-- Документы для сотрудничества (дублирующий блок - видимый) -->
        <div class="col-md-12">
            <div class="stat-docs-item">
                <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                <a href="https://em-nsk.ru/sahmatka2/reglament_newc.php" class="stat-docs-item__title iframe_r">
        ...
        <div class="row" style="margin: 15px; border-bottom: 1px solid #EEE; margin-bottom: 30px;">
            <div class="col-md-6" style="padding-left: 0;">
                <div class="stat-docs-item" style="float:left; width:auto; min-width: 250px;">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=https://em.m2profi.pro/oferta/stalker.docx?x=773766">
                        Субагентский договор <br> OOO "Сталкер"  (публичная  оферта)
                    </a>
                </div>
            </div>
            <div class="col-md-6" style="padding-left: 0;">
                <div class="stat-docs-item" style="display:none; width:auto; min-width: 250px;">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=https://em.m2profi.pro/oferta/m2.docx?x=130514">
                        Субагентский договор  <br>OOO "М2"   (публичная  оферта)
                    </a>
                </div>
            </div>
        </div>	

        <!-- Доп. соглашения до 30.06.2024 (скрыты) -->
        <div class="row" style="margin: 15px; border-bottom: 1px solid #EEE; margin-bottom: 30px; display:none;">
            <div class="col-md-6" style="padding-left: 0;">
                <div class="stat-docs-item" style="float:left; width:auto; min-width: 250px;">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=/sahmatka2/dopdog15042024/Дополнительное соглашение до 30.06.2024 между ООО Сталкер и ИП.docx">
                        Доп. соглашение <br>до   30.06.2024 <br> OOO "Сталкер" 
                    </a>
                </div>
                <div class="stat-docs-item" style="width:auto; min-width: 250px;">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=/sahmatka2/dopdog15042024/Дополнительное соглашение до 30.06.2024 между ООО М2 и ИП.docx">
                        Доп. соглашение <br>до   30.06.2024 <br> OOO "М2" 
                    </a>
                </div>
            </div>
            <div class="col-md-6" style="padding-left: 0;">
                <div class="stat-docs-item" style="float:left; width:auto; min-width: 250px;">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=/sahmatka2/dopdog15042024/Дополнительное соглашение до 30.06.2024 между ООО Сталкер и ООО.docx">
                        Доп. соглашение <br>до   30.06.2024 <br> OOO "Сталкер" 
                    </a>
                </div> 
                <div class="stat-docs-item" style="width:auto; min-width: 250px;">
                    <div class="stat-docs-item__icon"><img src="template/default/images/doc.png" alt=""></div>
                    <a class="stat-docs-item__title iframe_r" href="https://em-nsk.ru/sahmatka2/reglament.php?q=/sahmatka2/dopdog15042024/Дополнительное соглашение до 30.06.2024 между ООО М2 и ООО.docx">
                        Доп. соглашение <br>до   30.06.2024 <br> OOO "М2" 
                    </a>
                </div> 
            </div>
    ...
    <!-- Скрытый раздел коммерческой недвижимости (удален из отображения) -->
    
    <!-- Информация о днях приема -->
    <span class="com_header" style="font-size: 18px; color: rgb(47, 64, 73); margin-top: 30px; display: block; font-weight: 500;">
        Дни приема актов: понедельник, вторник, четверг с 9.30 до 14.00
    </span>
