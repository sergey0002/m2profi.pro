...
$table_sold = generate_stats_table("Проданные квартиры", [3]);
$table_unsold = generate_stats_table("Непроданные квартиры (свободные + бронь агентств, застройщика подрядчиков)", [0, 2, 4, 5, 6]);
$table_booked = generate_stats_table("Забронированные квартиры (бронь агентств и ОП)", [4]);
