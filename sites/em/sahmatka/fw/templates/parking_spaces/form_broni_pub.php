...
.mdl-tabs__item.active {
  ...
  <div class="mdl-inner" id="printableArea">
          ...
          <div class="mdl-pln">
            <div class="mdl-pln__top"><?=$data['data']['homes_kvartal_title']?>  </div>
				<div class="col-md-6 col-xs-12" style="text-align:center; position:relative;">
				  <img src="https://em.m2profi.pro/sahmatka//images/parkingcar.png" style="max-height: 500px; max-width: 100%; display: inline-block;  ">
    ...
    <div class="mdl-foot">
      ...
      <form action="https://em.m2profi.pro/sahmatka/ajax_router.php?ctr=parking_spaces&act=card_ajaxform" method="POST"  data-fp-id="public_pcard" class="formprotect mdl-form no-print  ">
