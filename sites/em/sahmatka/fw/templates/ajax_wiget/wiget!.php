...
// <script> 
	...
	*/
	...
	// Начальная загрузка данных 
	 sendAjaxForm( 'street' , 'rentsearch' , 'https://em.m2profi.pro/sahmatka/ajax_router.php?ctr=<?=$v['ctr']?>&act=sel_street',0); // Грузим содержимое селек

	 
	 
	// Начальная загрузка данных 
 	sendAjaxForm( 'rent_search_result' , 'rentsearch' , 'https://em.m2profi.pro/sahmatka/ajax_router.php?ctr=<?=$v['ctr']?>&act=<?=$v['act']?>',0); // Грузим содержимое селек
