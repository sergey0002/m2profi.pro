	...
	<?php if (!$error): ?>
		<div class="feed-summary">
			...
			<div class="feed-summary__grid">
				...
				<div><span>Уник. домов (building-name):</span> <b><?= (int)($stats['buildings'] ?? 0) ?></b></div>
				<div><span>Уник. yandex-building-id:</span> <b><?= (int)($stats['yandex_building_ids'] ?? 0) ?></b></div>
				<div><span>С пустым yandex-building-id:</span> <b><?= (int)($stats['empty_yandex_building_id'] ?? 0) ?></b></div>
				<div><span>Уник. yandex-house-id:</span> <b><?= (int)($stats['yandex_house_ids'] ?? 0) ?></b></div>
				<div><span>Уник. адресов:</span> <b><?= (int)($stats['addresses'] ?? 0) ?></b></div>
				<div><span>Без картинки:</span> <b><?= (int)($stats['no_image'] ?? 0) ?></b></div>
				<?php if (!empty($stats['generation_date'])): ?>
					<div><span>generation-date:</span> <b><?= feed_preview_h($stats['generation_date']) ?></b></div>
				<?php endif; ?>
			</div>
		...
		<form method="get" action="/sahmatka/ctrind.php" class="feed-filters">
			...
			<div>
				...
				<a href="/sahmatka/ctrind.php?ctr=yandex_feed&act=index" style="margin-left:10px;font-size:13px;">Все</a>
			</div>
		</form>
