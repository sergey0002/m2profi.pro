...
<div class="cp-edit cp-index-page container mobc">
    <?php if (empty($data['list'])): ?>
        <div class="cp-empty cp-empty--index">
            ...
            <p class="cp-empty__lead">
                Коммерческое предложение — это подборка квартир с вашими примечаниями и персональной ссылкой для клиента.
            </p>
            <ol class="cp-empty__steps">
                <li>Откройте нужную квартиру на шахматке.</li>
                <li>В карточке квартиры нажмите «Добавить к предложению» — создайте новое или выберите существующее.</li>
                <li>Добавьте другие квартиры, напишите примечания и вводный текст.</li>
    ...
    <?php else: ?>
        <p class="cp-index-page__intro">
            Здесь все ваши подборки для клиентов. Откройте предложение, чтобы добавить квартиры, изменить текст и получить ссылку.
        </p>
...
<script src="/sahmatka/template/default/js/compred.js?v=3"></script>
