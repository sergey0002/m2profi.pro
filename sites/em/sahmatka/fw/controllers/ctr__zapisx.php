...
############## ЗАПИСЬ
	...
	function act__sel_section_zapis()
	{
		...
		{ 
			 ...
			 if($_POST['home_id']=='48' && $v['section_id']=="2"){continue;}
	...
	function act__sel_date_zapisx()
	{
		...
		{  
			 ...
			 { 
				...
				// --- НОВОЕ УСЛОВИЕ ДЛЯ 48 ДОМА ---
				if($_POST['home_id'] == "48")
				{
					$section = $_REQUEST['section_id'];
					
					if ($section == 2) {
						// Секция 2: 3,4,5,10,11,12 февраля и 17,18,19,24,25,26,31 марта
						$allowed_2 = [
							'03.02.2026', '04.02.2026', '05.02.2026', '10.02.2026', '11.02.2026', '12.02.2026',
							'17.03.2026', '18.03.2026', '19.03.2026', '24.03.2026', '25.03.2026', '26.03.2026', '31.03.2026'
						];
						if (!in_array($fd, $allowed_2)) { $iskl = false; }
					} else {
						// Все остальные кроме 2 секции: 17,18,19,24,25,26 февраля и 3,4,5 марта
						$allowed_others = [
							'17.02.2026', '18.02.2026', '19.02.2026', '24.02.2026', '25.02.2026', '26.02.2026',
							'03.03.2026', '04.03.2026', '05.03.2026'
						];
						if (!in_array($fd, $allowed_others)) { $iskl = false; }
					}
				}
				// ---------------------------------
		...
		else
		{
			...
			if(  $free  )
			{
				...
				{ 	 
					...
					multi_attach_mail('89236470002@mail.ru', 'Запись на выдачу ключей - дом:'.$this->homes_arr[$data['home_id']]['title'].' кв.:'.$data['apartment_num'].' дата:'.$_POST['date'].' время:'.$data['time'], $con, 'sdsasd@m2profi.pro', 'em-nsk.ru');
