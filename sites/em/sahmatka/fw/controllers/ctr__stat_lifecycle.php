...
{ 
    ...
    function act__index()
    {
        ...
        <script>
            ...
            createLineChart('percentSalesChart', 'Продажи в % от кол-ва квартир в выборке (накопительно)', 
                <?= json_encode($charts_data['labels']) ?>, <?= json_encode($charts_data['percent_sales_datasets']) ?>, true);
            createLineChart('percentBookingsChart', 'Брони в % от кол-ва квартир в выборке (накопительно)', 
