		...
		<div class="col login-modal-col-main">
			<div class="login-modal-main">
				...
				<div style="background: #FFF; padding: 30px;   position:relative; margin:5vh 0 0;">
					...
					<a href="https://em-nsk.ru/reg/" style="color: #056bf5; display: block; margin-top: 10px;">Документов для сотрудничества &nbsp;&nbsp; <img src="https://em.m2profi.pro/rstr.png"></a>
		...
		<div class="col login-modal-col-pict">
			<div class="login-modal-pict">
				<div class="login-modal__caption">
					...
					<div class="login-modal__text">Специалист по работе с партнерами: <br> Татьяна Чечушкова</div>
					<div class="login-modal__contact">
						...
						<div class="login-modal__contact-item">E-Mail: <a
								href="mailto:op-an@em-nsk.group">op-an@em-nsk.group</a></div>
					</div>
				</div>
			</div>
		</div>
