...
$str_arr3['image_pb'] = 'https://em.m2profi.pro/sahmatka/pbplans/'.$str_arr3['home_id'].'/'.$str_arr[2].'/'.$floor_imgdir.'/'.$a.'.svg';
...
SELECT '34', '2', '110', '0', '1', '5200000', NULL, '64.60', '3с', '0', '', '', '', NULL, '3', '3', '30086', '2021-10-21 10:01:25', NULL, 'https://em.m2profi.pro/sahmatka/pbplans/32/2/64.6.svg', NULL, NULL, NULL, NULL
FROM `apartaments`
...
*/
 ...
 //UPDATE apartaments SET image_pb = REPLACE(image_pb, 'https://em-nsk.ru/sahmatka/pbplans/', 'https://em.m2profi.pro/sahmatka/pbplans/') where apartaments.home_id=33
