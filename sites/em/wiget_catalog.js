   if (!window.$) {
       ...
       script.src = "https://em.m2profi.pro/sahmatka/template/default/libs/jquery-3.3.1/jquery-3.3.1.min.js";
   ...
   $(document).ready(function() {
       ...
       */
	   ...
	   function loaddata()
	   {
		   ...
		   sendAjaxForm('zapisdata', 'filtrform', 'https://em.m2profi.pro/sahmatka/ajax_router.php?ctr=apartments&act=data', 0, 'progressbar', preload , postload ); 

		  
		   //  sendAjaxForm('zapisdata', 'filtrform', 'https://em.m2profi.pro/sahmatka/ajax_actions.php?load=data&controller=catalog', 0, 'progressbar', preload , postload ); 
	   }
               ...
               array.forEach(function(item, i, arr) {
                   if (item) {
                       ...
                       var preload = function(item) {
                           ...
                           //  sendAjaxForm(item, formid, 'https://em.m2profi.pro/sahmatka/ajax_actions.php?load=' + item + '&controller=' + controller, 1, 'progressbar', preload()); // Грузим содержимое селек
					   
					     sendAjaxForm(item, formid, 'https://em.m2profi.pro/sahmatka/ajax_router.php?ctr=apartments&act=' + item, 1, 'progressbar', preload()); // Грузим содержимое селек
