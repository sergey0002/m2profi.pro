...
class router
{
    ...
    function action_content($controller = '', $action = '', $vars = '')
    {
        ...
        // В оригинальной системе проверка авторизации происходит в header.php
        // Поэтому здесь мы не будем повторно проверять авторизацию
