		...
		{ 
			...
			*/
			...
			else // ИНфа о квартире
			{
			    ...
			    $edit_url = 'http://' . $GLOBALS['config']['domain'] . '/'sahmatka/form_order.php?home_id='.$home.'&apartment_num='.$end_etza_num.'&apartments='.$k;
