...
### ВХОД В СИСТЕМУ (ОБРАБОТКА ФОРМЫ) - ПЕРЕМЕЩЕНО В НАЧАЛО ФАЙЛА!
if (isset($_POST['submit'])) // Отлавливаем нажатие кнопки "Отправить"
{
	...
	{    
		...
		if (empty($result['id'])) // Если запрос к бд не возвразает id пользователя
		{
...
if( $_SESSION['sh_login'] )
{
	...
	else
	{
		...
		unset($_SESSION['users_group_id']); // Чистим 
	}
		...
		<div class="col login-modal-col-main">
			<div class="login-modal-main">
				...
				<div class="login-modal-form">
					<div class="login-modal-form__logo"><img src="/sahmatka/template/default/images/logo.svg" alt=""><!-- Лого --></div>
					<div class="login-modal-form__title">Документы</div>
					<div class="login-modal-form__subtitle">Авторизация</div>
					<form action="/sahmatka/ctrind.php" method="post">
	...
	<div class="col login-modal-col-pict">
			<div class="login-modal-pict">
				<div class="login-modal__caption">
					<div class="login-modal__logo"  > <img src="/sahmatka/template/default/images/logo.svg" alt=""> <!-- Лого --> </div>
