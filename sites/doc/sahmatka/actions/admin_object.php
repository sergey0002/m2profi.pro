 ...
 if(trim($_POST[newplan])) // Массовая редактирование планироваок
 {
  ...
  if(trim($_POST[newarea])) // Массовая редактирование планироваок
 {
 ...
 if(trim($_POST[newrooms])) // Массовая редактирование планироваок
 {
  ...
  if(trim($_POST[newtext])) // Массовая редактирование планироваок
 {
...
if(trim($_POST[newstatus])) // Массовая редактирование Статуса
 {
...
?>
		...
		<div class="acc-body" style="display:none;" >
			 <input type="text" name="newplan" placeholder="Полная ссылка на файл планировки"  value="" autocomplete="off" class="inpx" style="width:100%; text-transform: none;" /> <br/>
		</div>
		 
		
		
		<div class="acc-head" style="display:none;" >
			Площадь
		</div>
		<div class="acc-body" style="display:none;" >
