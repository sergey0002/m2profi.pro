...
if($_SESSION['sh_login'] && !$_SESSION['adm_caption'] && $_SESSION['sh_login']!='admin' &&  $_SESSION['sh_login']!='uservip' &&  $_SESSION['sh_login']!='partner' )
{
	$q.='AND users.login="'.$_SESSION['sh_login'].'"  '; // только его брони
}
//  админ агентства
elseif($_SESSION['sh_login'] && $_SESSION['adm_caption'] && $_SESSION['sh_login']!='admin' &&  $_SESSION['sh_login']!='uservip' &&  $_SESSION['sh_login']!='partner' )
{
