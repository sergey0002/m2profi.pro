			...
			<ul class="sidenav-menu">
			 ...
			 <ul class="sidenav-menu">
				...
				?>
				    ...
				    <li><a style="display:none;" href="ctrind.php?ctr=users_group" class="active"><i><img src="template/default/images/menu-icon-1.svg" alt=""></i>Группы</a></li>
					<li><a style="display:none;" href="ctrind.php?ctr=permissions" class="active"><i><img src="template/default/images/menu-icon-1.svg" alt=""></i>Права</a></li>
				<?
				}
				?>
			</ul>
			  ...
			  <ul class="sidenav-menu">
				<li class="sidenav-dropmenu">
					<span></span>
										<a href="#" ><i><img src="template/default/images/carp.png" style="bottom: 7px;" alt=""></i>Внешние данные</a>
					<ul class="sidenav-submenu " >
						<li><a href="ctrind.php?ctr=exsources&source=em">em-nsk.ru</a></li>
