...
<link href="<?=$GLOBALS['config']['domains']['gl']?>/fonts/stylesheet.css" rel="stylesheet">
...
{	 
  	 ...
  	 // $mess->send( 'info@g-lounge.ru' ,'Заявка с сайта EM-NSK.ru - ФОРМА КАРТОЧКИ УЧАСТКА -'.$act.' '.$_POST['name'].' ', $message );
		...
		print '<br><h1>Заявка принята</h1><h2><br> Специалист отдела продаж свяжется с вами в ближайшее время.</h2>';
}
?>
<?
