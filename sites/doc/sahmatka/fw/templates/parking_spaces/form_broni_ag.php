 ...
 <div class="row">
  ...
  <div class="row">
    <div class="col-md-6 col-xs-12" style="text-align:center;">
      <img src="<?=$GLOBALS['config']['base_url']?>/sahmatka//images/parkingcar.png" style="max-height:600px; max-width:100%">
...
if( $stat=="2" || !$stat   ) 
{
	?>
                      <form action="iframe_router.php?ctr=parking_spaces&act=order&id=<?=$data['parking_space_id'];?>" method="post" enctype="multipart/form-data" method="post">
                        ...
                        <span style="font-size:20px;">Подтверждаю согласие с <a target="_blanc"  style="font-size:20px;" href="<?=$GLOBALS['config']['domains']['em_nsk']?>/sahmatka/reglament.php">регламентом </a></span>
                        <br/>
                        <br/>
