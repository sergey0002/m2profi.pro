...
{  
	...
	function get_base_sql($filtr_data='')
	{
		...
		{
			$q.=' AND (`rent_objects`.`sale`  = "0" OR `rent_objects`.`sale` = "2" )';
		}
	   ...
	   <?
 		...
 		foreach($files as $file) 
		{
			...
			{		
				...
				{
					//<?=$GLOBALS['config']['domains']['em']?>/thumbs/?name=sahmatka/logo90.jpeg
 ...
 $('.slider22').slick({
      ...
      <div class="col-md-6 p10">
        <div style="margin: 0 0 29px; display: flex; justify-content: space-between;">
          ...
          <div>
            <a href="javascript:(print());">
              <img src="<?=$GLOBALS['config']['domains']['em']?>/m2rent/images/p1.svg" alt=""></a>
            <a href="" style="display:none;">
              <img src="<?=$GLOBALS['config']['domains']['em']?>/m2rent/images/m1.svg" alt="" style="padding-left: 20px;"></a>
          </div>
        </div>
        <p class="rent_a" style="font-weight: 700;color: #000000;"><?=$v['h_adress']?> / <?=$v['adress']?></p>
        <p>
          <a href="#map" class="rent_a"><img src="<?=$GLOBALS['config']['domains']['em']?>/m2rent/images/map.svg" alt="">Помещение на карте</a>
        </p>
		<br/>
        <p>
			<?=$v['comment']?>
		...
		if($v['status'] == 2 || !$v['status'] )
					{
						?>	
					 <a href="<?=$GLOBALS['config']['domains']['em']?>/sahmatka/iframe_router.php?ctr=rentobjects&act=order&id=<?=$v['rent_objects_id']?>">
        ...
        <p class="form_rz_p"> Отправляя заявку вы автоматически даете свое <a href="<?=$GLOBALS['config']['domains']['em']?>/politics.docx"> согласие на обработку персональных данных</a></p>
      </div>
...
<div style="display: flex;">
	<img src="<?=$GLOBALS['config']['domains']['em']?>/m2rent/images/map.svg" alt="" style="margin: 0px 0px 1